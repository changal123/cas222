...
<body>
	...
	<main class="wrapper">
		...
		<article>
			...
			<h3>Saturday</h3>
			<p>Long Course Traithlon<br> 7:00 AM<br><br> Olympic Traithlon<br> 7:30 AM<br><br>10K<br> 7:15 AM<br><br>Half Marathon<br> 7:15 AM</p>

			<h3>Sunday</h3>
			<p>Sprint Traithlon<br> 8:00 AM<br><br>Try-a-Tri <br>8:20 AM <br><br>Splash n Dash <br> 12:00 PM</p>
		...
		<aside>
			...
			<div id="slideshow">
				<div>
					<img src="images/ace1.jpg" alt="Water">
				</div>
				<div>
					<img src="images/ace2.jpg" alt="Happy Participant">
				</div>
				<div>
					<img src="images/ace3.jpg" alt="Biking">
				</div>
				<div>
				...
				<div>
					<img src="images/ace6.jpg" alt="Contestants">
				</div>
				<div>
					<img src="images/ace8.jpg" alt="10K">
				</div>
				<div>
					<img src="images/ace9.jpg" alt="Other Bikes">
				</div>
				<div>
					<img src="images/ace10.jpg" alt="Finish Line">
				</div>
			</div>

			<div id="weather">
				<script src="https://apps.elfsight.com/p/platform.js" defer></script>
				<div class="elfsight-app-520ffdb9-ae86-4ec8-b404-d27dcb85a032"></div>
			</div>
